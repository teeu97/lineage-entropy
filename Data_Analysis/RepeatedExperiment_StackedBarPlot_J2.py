...
for barcode, row in true_number_table.iterrows():
    new_list = [1, sum(row[13:16]), sum(row[29:32]), sum(row[53:56]), sum(row[69:72]), sum(row[77:80])]
...
plt.savefig('RepeatedExperiment_StackedBarPlot_J2.svg', bbox_inches='tight', format='svg', dpi=720)
