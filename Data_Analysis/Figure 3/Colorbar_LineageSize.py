...
plt.savefig('Colorbar_LineageSize_Horizontal.svg', format='svg', bbox_inches='tight', dpi=720)
plt.close()

plt.figure()
plt.axis('off')
cbar = plt.colorbar(color_scalarMap, orientation='vertical')
plt.savefig('Colorbar_LineageSize_Vertical.svg', format='svg', bbox_inches='tight', dpi=720)
plt.close()
