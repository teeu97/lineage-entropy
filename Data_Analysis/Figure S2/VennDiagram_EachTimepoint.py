"""
VennDiagram_EachTimepoint.py shows the Venn diagram that shows the number of lineages that are assigned to S1, S2, S3,
...
# Fimd the vector magnitude
def vector_size(x_displacement, y_displacement):
    return math.sqrt(x_displacement ** 2 + y_displacement ** 2)

# initialize the lineage analysis
