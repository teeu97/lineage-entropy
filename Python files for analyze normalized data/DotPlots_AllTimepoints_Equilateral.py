...
def scatter_plot_right_all(all_barcode_list):
    ...
    ax.text(10.5, math.sqrt(75)-0.15, 'State 1')
    ax.text(-1.5, math.sqrt(75)-0.15, 'State 2')
    ax.text(4.5, -0.55, 'State 3')
    ax.axis('off')
    ...
    plt.savefig("DotPlots_AllTimepoints_Equilateral.svg", bbox_inches='tight', format='svg', dpi=720)
    plt.show()
