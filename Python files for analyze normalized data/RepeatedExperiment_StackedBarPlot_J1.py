...
for barcode, row in true_number_table.iterrows():
    new_list = [1, sum(row[9:12]), sum(row[25:28]), sum(row[49:52]), sum(row[65:68]), sum(row[37:40])]
...
plt.savefig('RepeatedExperiment_StackedBarPlot_J1.svg', bbox_inches='tight', format='svg', dpi=720)
